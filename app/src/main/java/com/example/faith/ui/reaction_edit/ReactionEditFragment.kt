...
import com.example.faith.ui.post_edit.PostEditFragmentArgs
import com.example.faith.ui.post_edit.PostEditViewModel
import com.example.faith.ui.post_edit.PostEditViewModelFactory
...
class ReactionEditFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val binding = DataBindingUtil.inflate<ReactionEditFragmentBinding>(inflater,
            R.layout.reaction_edit_fragment, container, false)
